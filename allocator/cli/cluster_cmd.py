...
@click.option("--n-closest", type=int, default=15, help="Number of closest neighbors in graph")
@click.option("--balance-edges", is_flag=True, help="Balance edge weights")
@click.option("--buffoon", is_flag=True, help="Use buffoon mode")
@click.option("--random-state", type=int, help="Random seed for reproducibility")
@click.option("--output", "-o", type=click.Path(), help="Output file path")
@click.option("--plot", is_flag=True, help="Show clustering plot")
@click.option("--save-plot", type=click.Path(), help="Save plot to file")
